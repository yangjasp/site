...
I made a simple app using RShiny that calculates these probabilities based on adjustable inputs. Check it out [here](https://yangjasp.shinyapps.io/shinycovid/).
